...
def main(sigma_r_u, sigma_r_v, tau_r_u, tau_r_v):
    ...
    ax.plot(np.mean(np.asarray(x_sol), axis=0), np.mean(np.asarray(y_sol), axis=0), transform=ccrs.PlateCarree(), color="red", zorder=100)
...
if __name__ == "__main__":
    main(0.17052557777999278,0.16467240468584232,0.7015165441176471,0.6913807189542484)